...
These commands when entered into the console of the connected computer and are sent to the controller  which are in turn parsed into the appropriate output from the controller.
The current state of the system is provided on a LCD display to allow for the system state to remain always visible. System information is also sent to the console to allow for the data to be visualized during operations ( with software such as [Serial Studio](https://github.com/Serial-Studio/Serial-Studio)).
